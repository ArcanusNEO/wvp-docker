...
docker run -d --restart=always --name zlmediakit --network=container:mysql-wvp lucas/zlmediakit:0.1.0
...
docker run -d --restart=always --name wvp -e MYSQL_PWD=$MYSQL_ROOT_PASSWORD -p 5060:5060 --network=container:mysql-wvp -p 5060:5060/udp -p 18080:18080 -p 80:80 -p 10000:10000 -p 10000:10000/udp -p 30000-30500:30000-30500 -p 30000-30500:30000-30500/udp lucas/wvp:0.1.0
